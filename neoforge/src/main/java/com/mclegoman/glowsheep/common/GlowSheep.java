...
public class GlowSheep {
    ...
    public static final DeferredRegister.Blocks blocks = DeferredRegister.createBlocks(GlowSheep.modId);
    public static final DeferredRegister.Items items = DeferredRegister.createItems(GlowSheep.modId);
    public static final DeferredRegister<CreativeModeTab> creativeTabs = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, GlowSheep.modId);

    public static final List<GlowWoolVariant> woolBlocks = addWoolBlocks(woolColors());
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> creativeTab = creativeTabs.register(GlowSheep.modId, () -> CreativeModeTab.builder()
